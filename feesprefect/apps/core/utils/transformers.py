...
def deep_camel_case_transform(data: Dict) -> Dict:
    return deep_case_transform(data, to_camel_case)  # type: ignore


def deep_snake_case_transform(data: Dict) -> Dict:
    return deep_case_transform(data, to_snake_case)  # type: ignore


# Reference
# https://gist.github.com/martin056/65a04eb37da98d25f1c4712fb70f939f
